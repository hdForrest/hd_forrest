//
//  Intermediate_TableViewController.swift
//  Forrest
//
...
class Intermediate_TableViewController: UITableViewController
{
    ...
    func clicked_bt()
    {
        ...
        //performSegueWithIdentifier("clicked_ok_inte", sender: self)
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        {
        case 0:
            let cell = tableView.dequeueReusableCellWithIdentifier("inte_cell_1", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "inte_1")
            cell.addSubview(cell_img_text)
            
            return cell
        case 1:
            let cell = tableView.dequeueReusableCellWithIdentifier("inte_cell_2", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "inte_2")
            cell.addSubview(cell_img_text)
            
            return cell
        case 2:
            let cell = tableView.dequeueReusableCellWithIdentifier("inte_cell_3", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "inte_3")
            cell.addSubview(cell_img_text)
            
            return cell
        default:
            let cell = tableView.dequeueReusableCellWithIdentifier("inte_cell_4", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "inte_4")
            cell.addSubview(cell_img_text)
