//
//  Free_TableViewController.swift
//  Forrest
//
...
class Free_TableViewController: UITableViewController
{
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        {
        case 0:
            let cell = tableView.dequeueReusableCellWithIdentifier("free_cell_1", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "free_1")
            cell.addSubview(cell_img_text)
            
            return cell
        case 1:
            let cell = tableView.dequeueReusableCellWithIdentifier("free_cell_2", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "free_2")
            cell.addSubview(cell_img_text)
            
            return cell
        case 2:
            let cell = tableView.dequeueReusableCellWithIdentifier("free_cell_3", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "free_3")
            cell.addSubview(cell_img_text)
            
            return cell
        case 3:
            let cell = tableView.dequeueReusableCellWithIdentifier("free_cell_4", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "free_4")
            cell.addSubview(cell_img_text)
            
            return cell
        case 4:
            let cell = tableView.dequeueReusableCellWithIdentifier("free_cell_5", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "free_5")
            cell.addSubview(cell_img_text)
            
            return cell
        default:
            let cell = tableView.dequeueReusableCellWithIdentifier("free_cell_6", forIndexPath: indexPath)
            
            cell.backgroundColor = table_color
            let cell_img_text : UIImageView = UIImageView(frame: CGRectMake(0, 0, 375, 88.5))
            cell_img_text.image = UIImage(named: "free_6")
            cell.addSubview(cell_img_text)
